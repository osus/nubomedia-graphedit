...
app.on('ready', function() {
  ...
  mainWindow = new BrowserWindow({icon: __dirname + '/images/nubomedia-logo.png'});/*width: 800, height: 600, "node-integration": false*/
console.log(__dirname + '/images/nubomedia-logo.png');
